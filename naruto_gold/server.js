...
app.post("/api/create-order", async (req, res) => {
  // Nhận thêm customerEmail từ req.body
  const {
    customerName,
    contactPhone,
    customerEmail,
  ...
  if (!customerName || !gameAccount || !gamePassword || !customerEmail) {
    return res
      .status(400)
  ...
  try {
    ...
    request.input("customerEmail", sql.VarChar, customerEmail); // <--- Truyền tham số Email
    ...
    // =========================================================================
    // THƯ SỐ 1: BẮN CHO ADMIN (BẠN) - CHỨA TÀI KHOẢN MẬT KHẨU GAME
    // =========================================================================
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr>
            ...
            <td style="padding:10px;border-bottom:1px solid #334155;">
              <a href="https://zalo.me/${contactPhone}" style="color:#10b981;text-decoration:none;">
                ${contactPhone}
              </a>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style="padding:10px;border-bottom:1px solid #334155;">
              <code style="color:#6ef0b2;font-size:15px;">${gameAccount}</code>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style="padding:10px;border-bottom:1px solid #334155;">
              <code style="color:#ff4d4d;font-size:15px;">${gamePassword}</code>
            </td>
          </tr>
  ...
  `,
    ...
    // =========================================================================
    // THƯ SỐ 2: BẮN TỰ ĐỘNG CHO KHÁCH HÀNG (EMAIL CẢM ƠN & XÁC NHẬN)
    // =========================================================================
    const customerMailOptions = {
      from: '"NarutoGold Agency" <support@narutogold.com>',
      to: customerEmail, // Gửi đến địa chỉ email khách vừa nhập
    ...
    // Gửi song song cả 2 bức thư cùng một lúc
